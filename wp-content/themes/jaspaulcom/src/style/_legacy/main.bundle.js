;(self['webpackChunkjaspaul_com'] = self['webpackChunkjaspaul_com'] || []).push([
  [179],
  {
     ...
     */
      ...
      ;(function (factory) {
        'use strict'
        if (true) {
          !((__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(755)]),
    ...
    /***/ 368: /***/ (
      ...
      var jquery_default = /*#__PURE__*/ __webpack_require__.n(jquery) // CONCATENATED MODULE: ./node_modules/@fancyapps/ui/dist/fancybox.esm.js
      ...
      const a = (t, e) =>
          e ? Math.sqrt((e.clientX - t.clientX) ** 2 + (e.clientY - t.clientY) ** 2) : 0,
        r = (t, e) =>
          e
            ? {
          ...
          ;(this._element = t),
            ...
            (this._touchStart = (t) => {
              for (const e of Array.from(t.changedTouches || []))
                this._triggerPointerStart(new n(e), t)
            }),
            (this._move = (t) => {
              const e = this.currentPointers.slice(),
                i = ((t) => 'changedTouches' in t)(t)
                  ? Array.from(t.changedTouches).map((t) => new n(t))
                  : [new n(t)]
              for (const t of i) {
            ...
            (this._pointerEnd = (t) => {
              ;(t.buttons > 0 && 0 !== t.button) ||
                (this._triggerPointerEnd(new n(t), t) &&
            ...
            (this._touchEnd = (t) => {
              for (const e of Array.from(t.changedTouches || []))
                this._triggerPointerEnd(new n(e), t)
            }),
      ...
      class l {
        ...
        option(t, e, ...i) {
          ...
          let s =
            ((o = t),
            (n = this.options),
            o.split('.').reduce(function (t, e) {
              return t && t[e]
            }, n))
          var o, n
          return (
            'function' == typeof s && (s = s.call(this, this, ...i)), void 0 === s ? e : s
          )
        }
        localize(t, e = []) {
          return (t = (t = String(t).replace(/\{\{(\w+).?(\w+)?\}\}/g, (t, i, s) => {
            let o = ''
            s
              ? (o = this.option(`${i[0] + i.toLowerCase().substring(1)}.l10n.${s}`))
        ...
        attachPlugins(t) {
          ...
          for (const [s, o] of Object.entries(t || {}))
            !1 === this.options[s] ||
              this.plugins[s] ||
              ((this.options[s] = e({}, o.defaults || {}, this.options[s])),
              (i[s] = new o(this)))
      ...
      class d extends l {
        ...
        updateMetrics(t) {
          ...
          if (
            ((y -= parseFloat(b.paddingLeft) + parseFloat(b.paddingRight)),
            ...
            Object.assign(s.style, { width: `${h}px`, height: `${l}px`, transform: '' })
          }
          if (
            (r &&
              (Object.assign(o.style, { width: `${h}px`, height: `${l}px` }),
              (this.viewport = { ...this.viewport, width: h, height: l })),
        ...
        zoomTo(t = this.option('baseScale'), { x: e = null, y: s = null } = {}) {
          ...
          null === e && (e = this.content.width * o * 0.5),
            null === s && (s = this.content.height * o * 0.5)
          const { deltaX: n, deltaY: a } = this.getZoomDelta(t, e, s)
          ;(e = this.content.x - n),
            (s = this.content.y - a),
            this.panTo({ x: e, y: s, scale: t, friction: this.option('zoomFriction') })
        }
        ...
        setDragResistance() {
          ...
          if (
            ...
            e && ((o = this.dragPosition.y < e.from), (n = this.dragPosition.y > e.to)),
            (i || s) && (!i || !s))
          ) {
          ...
          if (
            (t
              ? ((e = i(this.transform.x)),
                (s = i(this.transform.y)),
                (o = this.transform.scale),
                (this.content = { ...this.content, x: e, y: s, scale: o }))
              : ((e = i(this.content.x)),
                (s = i(this.content.y)),
                (o = this.content.scale / (this.content.width / this.content.fitWidth)),
                (this.content = { ...this.content, x: e, y: s })),
            ...
            let t, n
            ;(t = i(this.content.fitWidth * o)),
              (n = i(this.content.fitHeight * o)),
              (this.content.width = t),
              (this.content.height = n),
              (this.transform = { ...this.transform, width: t, height: n, scale: o }),
            ...
            this.$content.style.transform = `translate3d(${e}px, ${s}px, 0) scale(${o})`
      ...
      class g {
        ...
        onNavClick(t, e, i) {
          ...
          this.target.page !== n && this.target.slideTo(n, { friction: this.friction }),
      ...
      class y extends l {
        constructor(t, i = {}) {
          ...
          ;(this.slideNext = u(this.slideNext.bind(this), 250)),
            (this.slidePrev = u(this.slidePrev.bind(this), 250)),
            this.init(),
            (t.__Carousel = this)
        }
        init() {
        ...
        initLayout() {
          ...
          ;(this.$viewport =
            ...
            (this.$track =
              this.option('track') || this.$container.querySelector(`.${t}${e.track}`)),
            this.$track ||
        ...
        initSlides() {
          ...
          this.$viewport
            ...
            Array.isArray(this.options.slides) &&
              (this.slides = e(!0, [...this.slides], this.options.slides))
        }
        updateMetrics() {
          let t,
            e = 0,
          ...
          if (Number.isInteger(r) && e > o)
            for (let t = 0; t < this.slides.length; t += r)
              a.push({ indexes: s.slice(t, t + r), slides: this.slides.slice(t, t + r) })
          else {
            let t = 0,
              e = 0
            for (let i = 0; i < this.slides.length; i += 1) {
              let s = this.slides[i]
              ;(!a.length || e + s.width > o) &&
                (a.push({ indexes: [], slides: [] }), (t = a.length - 1), (e = 0)),
                (e += s.width),
                a[t].indexes.push(i),
                a[t].slides.push(s)
            }
          ...
          a.forEach((t, i) => {
            ;(t.index = i),
              ...
              l &&
                ...
                e > o &&
                ((t.left = Math.max(t.left, 0)), (t.left = Math.min(t.left, e - o)))
          })
          const c = []
          let d
          a.forEach((t) => {
        ...
        getSlideMetrics(t) {
          ...
          return (
            (e = e + (parseFloat(s.marginLeft) || 0) + (parseFloat(s.marginRight) || 0)),
        ...
        manageSlideVisiblity() {
          ...
          this.slides.forEach((e, i) => {
            let s = 0
            e.$el
              ? (i !== r || e.hasDiff ? (s = h + e.hasDiff * t) : (h = 0),
                (e.$el.style.left = Math.abs(s) > 0.1 ? `${h + e.hasDiff * t}px` : ''),
                r++)
              : (h += e.width)
          }),
        ...
        setPage(t, e) {
          ...
          if (
            ((t = ((s % a) + a) % a),
            this.option('infiniteX', this.option('infinite')) && r > h)
          ) {
      ...
      class E {
        ...
        processType(t) {
          ...
          if (!i || 'string' == typeof i) {
            if (
              ...
              ;(t.videoId = n),
                (t.src = `https://www.youtube-nocookie.com/embed/${n}?${e}`),
              ...
              const e = C(i, this.fancybox.option('Html.vimeo')),
                n = encodeURIComponent(o[1])
              ;(t.videoId = n),
                (t.src = `https://player.vimeo.com/video/${n}?${e}`),
                (t.vendor = 'vimeo'),
                (s = 'video')
            } else
              (o = i.match(
                ...
                : (o = i.match(
                  ...
                  ((t.src = `//maps.google.${o[1]}/maps?q=${o[2]
                    .replace('query=', 'q=')
            ...
            s ||
              ('#' === i.charAt(0)
                ? (s = 'inline')
                : (o = i.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
                ? ((s = 'html5video'),
                  (t.format = t.format || 'video/' + ('ogv' === o[1] ? 'ogg' : o[1])))
                : i.match(
              ...
              ('html5video' !== s && 'video' !== s) ||
                ((t.video = e({}, this.fancybox.option('Html.video'), t.video)),
                t._width && t._height
                  ? (t.ratio = parseFloat(t._width) / parseFloat(t._height))
                  : (t.ratio = t.ratio || t.video.ratio || S.video.ratio))
          }
        }
        onReady() {
        ...
        onRefresh(t, e) {
          e.slides.forEach((t) => {
            t.$el &&
              (t.$iframe && this.resizeIframe(t), t.ratio && this.setAspectRatio(t))
          })
        }
        setContent(t) {
          if (t && !t.isDom) {
      ...
      class P {
        ...
        getZoomInfo(t) {
          ...
          return (
            'auto' === l && (l = Math.abs(i / s - n / a) > 0.1),
            { top: r, left: h, scale: n && i ? i / n : 1, opacity: l }
          )
        }
        canZoom(t) {
          const e = this.fancybox,
        ...
        zoomIn() {
          ...
          t.trigger('reveal', e),
            i.panTo({ x: -1 * o, y: -1 * s, scale: n, friction: 0, ignoreBounds: !0 }),
        ...
        zoomOut() {
          ...
          const o = (t) => {
            ...
            t || r || (s *= 0.82),
              i.panTo({ x: -1 * n, y: -1 * o, scale: a, friction: s, ignoreBounds: !0 }),
              (s *= 0.98)
          }
      ...
      class L {
        ...
        static startFromUrl() {
          ...
          if (
            (o &&
              o.dispatchEvent(new CustomEvent('click', { bubbles: !0, cancelable: !0 })),
            t.getInstance())
          )
            return
        ...
        static onHashChange() {
          const { slug: t, index: e } = L.getParsedURL(),
            i = L.Fancybox,
            s = i && i.getInstance()
          if (s && s.plugins.Hash) {
            if (t) {
      ...
      const A = {
        ...
        items: {
          ...
          fullscreen: {
            ...
            click: function (t) {
              t.preventDefault(),
                T.element() ? T.deactivate() : T.activate(this.fancybox.$container)
            }
          },
          slideshow: {
            type: 'button',
      ...
      class z {
        ...
        build() {
          ...
          for (const n of this.fancybox.option('Toolbar.display')) {
            let a, r
            if (
              (t(n) ? ((a = n.id), (r = e({}, i[a], n))) : ((a = n), (r = i[a])),
      ...
      class F extends l {
        ...
        setItems(t) {
          ...
          for (const i of t) {
            ...
            !o &&
              ...
              !o && s.dataset && (o = s.dataset.lazySrc || s.dataset.src)),
          ...
          if (this.$backdrop) {
            const e = Math.abs(t.content.y),
              i =
                e < 1
                  ? ''
                  : Math.max(0.33, Math.min(1, 1 - (e / t.content.fitHeight) * 1.5))
        ...
        focus(t) {
          ...
          t
            ...
            ? w(n)
            : a.indexOf(document.activeElement) < 0 && w(e),
        ...
        static fromOpener(t, i = {}) {
          ...
          if (
            (n && !a && (s = h ? s.filter((t) => t.getAttribute(`${r}`) === h) : [n]),
            !s.length)
          )
            return !1
          const l = F.getInstance()
          return (
            !(l && s.indexOf(l.options.$trigger) > -1) &&
            ((o = n ? s.indexOf(n) : o),
            (s = s.map(function (t) {
            ...
            new F(s, e({}, i, { startIndex: o, $trigger: n })))
          )
        }
        static bind(t, e = {}) {
          function i() {
        ...
        static getInstance(t) {
          ...
          return (
            Array.from(M.values())
              .reverse()
              .find(
                (t) => !['closing', 'customClosing', 'destroy'].includes(t.state) && t
              ) || null
          )
        }
        static close(t = !0, e) {
          if (t) for (const t of M.values()) t.close(e)
          else {
      ...
      for (const [t, e] of Object.entries(F.Plugins || {}))
        'function' == typeof e.create && e.create(F)

      // EXTERNAL MODULE: ./node_modules/slick-carousel/slick/slick.js
      var slick = __webpack_require__(154) // CONCATENATED MODULE: ./src/slick.js
      // var jas = jas || {}
      // jas.Config = jas.Config || {}
      // jas.Page = jas.Page || {}
      // const sizeDesktop = 1000

      const sizeTablet = 768

      const initMenu = () => {
        jquery_default()('header button').on('click', function () {
          jquery_default()(this).toggleClass('active')
        })
      }

      const initSlider = () => {
        jquery_default()('.scores').slick({
          dots: false,
          infinite: true,
          slidesToShow: 1,
          slidesToScroll: 1,
        ...
        jquery_default()('.quote-list').slick({
          infinite: true,
          slidesToShow: 1,
          slidesToScroll: 1,
          autoplay: true,
      ...
      document.addEventListener('DOMContentLoaded', function () {
        setupSlider()
        jquery_default()('a[rel*=external]').on('click', function () {
          window.open(jquery_default()(this).attr('href'))
          return false
        })
        F.bind('a.fancybox, ul.fancybox a')
        // Fancybox.bind('.fancybox a', {
        //   type: 'image'
        // })
      })
      function setupSlider() {
        jquery_default().getScript('/inc/js/jquery.nivo.slider.pack.js', function () {
          jquery_default()('#slider')
            .parent('.slider-wrapper')
            .remove()
            .insertBefore('#wrap')
          jquery_default()('#slider').nivoSlider({
            pauseTime: 6000
          })
        })
        initSlider()
  ...
  /******/ (__webpack_require__) => {
    ...
    /******/ var __webpack_exports__ = __webpack_exec__(368)
    /******/
  }
])
